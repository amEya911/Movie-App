...
fun DetailScreen(navController: NavController, id: Int) {
    ...
    Box(
        ...
        BackgroundImage(details = details)
        MainImage(details = details)
        Column(
            Modifier
            ...
            DisplayMinuteDetails(details = details, modifier = Modifier)
            DisplayDescription(icon = Icons.Filled.Info, title = "Summary:", bodyText = details.plot)
            DisplayDescription(icon = Icons.Filled.Person, title = "Actors:", bodyText = details.actors)
            DisplayImageRow(details = details)
        }
    }
}

@Composable
fun DisplayImageRow(details: Details) {
...
@Composable
fun DisplayDescription(icon: ImageVector, title: String, bodyText: String) {
    Row {
        Icon(
            imageVector = icon,
...
@Composable
fun DisplayMinuteDetails(details: Details, modifier: Modifier) {
...
@Composable
fun BackgroundImage(details: Details) {
    Box(
        modifier = Modifier
            .fillMaxSize()
